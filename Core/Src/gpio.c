...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, STM_AUX_3_Pin|CAN_OK_Pin|CAN_ERROR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, STM_AUX_4_Pin|STM_AUX_1_Pin|STM_AUX_2_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = STM_AUX_4_Pin|STM_AUX_1_Pin|STM_AUX_2_Pin|BMS_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
